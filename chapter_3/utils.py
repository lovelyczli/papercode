    ...
    for i in range(len(grid_images)):
        ...
        if is_small:
            if grid_images[i].shape[-1] == 1:
                imsave(os.path.join( grid_image_path, "grid_image_small.png"), grid_images[i][0,:,:,0], format = "png")
            else:
                imsave(os.path.join(grid_image_path, "grid_image_small.png"), grid_images[i][0], format = "png")
        else:
            if grid_images[i].shape[-1] == 1:
